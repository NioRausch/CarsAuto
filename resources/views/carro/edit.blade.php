            ...
            <form method="POST" action="{{ route('carro.update', $carro->id) }}" enctype="multipart/form-data">
                ...
                <div class="flex">
                    ...
                    <div class="relative z-0 mb-6 w-1/2 group mr-3">
                        <input value="{{$carro->nome}}" type="text" name="nome" id="nome" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 mb-6 w-1/2 group ml-3">
                        <input value="{{$carro->modelo}}" type="text" name="modelo" id="modelo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="flex mt-10">
                    ...
                    <div class="relative z-0 mb-6 w-1/2 group mr-3 flex">
                        <div class="relative w-1/2 mr-3">
                            <input value="{{$carro->ano}}" type="number" name="ano" id="ano" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative w-1/2 ml-3">
                            <input value="{{$carro->ano_modelo}}" type="number" name="ano_modelo" id="ano_modelo" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 mb-6 w-1/2 group ml-3">
                        <input value="{{$carro->km}}" type="number" name="km" id="km" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="flex mt-10">
                    <div class="relative z-0 mb-6 w-1/2 group mr-3">
                        ...
                        <select id="cambio" name="cambio" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                            ...
                            <option @if($cambio=="Manual" )selected @endif value="Manual">Manual</option>
                            <option @if($cambio=="Automatico" )selected @endif value="Automatico">Automatico</option>
                        </select>
                    </div>
                    <div class="relative z-0 mb-6 w-1/2 group ml-3">
                        ...
                        <select id="combustivel" name="combustivel" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                            ...
                            <option @if($combustivel=="Gasolina" )selected @endif value="Gasolina">Gasolina</option>
                            <option @if($combustivel=="Etanol" )selected @endif value="Etanol">Etanol</option>
                            <option @if($combustivel=="Flex" )selected @endif value="Flex">Flex</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex mt-10">
                    ...
                    <div class="relative z-0 mb-6 w-1/2 group mr-3">
                        <input value="{{$carro->cor}}" type="text" name="cor" id="cor" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="cor" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nome</label>
                    </div>

                    <div class="relative z-0 mb-6 w-1/2 group ml-3">
                        <input value="{{$carro->preco}}" type="number" name="preco" id="preco" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <img class="w-full h-44 w-44 object-cover " src="{{ asset('images/' . $carro->img_path) }}">
                <button type="submit" class="mt-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Editar</button>
            </form>
